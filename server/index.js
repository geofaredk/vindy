...
const TYPES = { '.html': 'text/html; charset=utf-8', '.js': 'text/javascript; charset=utf-8', '.mjs': 'text/javascript; charset=utf-8', '.css': 'text/css; charset=utf-8', '.png': 'image/png', '.jpg': 'image/jpeg', '.svg': 'image/svg+xml', '.json': 'application/json', '.ico': 'image/x-icon', '.webmanifest': 'application/manifest+json' };
const STATIC = [
  ['/vendor/leaflet/', path.join(ROOT, 'node_modules/leaflet/dist/')],
  ['/vendor/mp4-muxer/', path.join(ROOT, 'node_modules/mp4-muxer/build/')],
  ['/vendor/gifenc/', path.join(ROOT, 'node_modules/gifenc/dist/')],
